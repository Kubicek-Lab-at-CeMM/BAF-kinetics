...
setwd("/Users/sgrosche/Development/200302_boxplots_diff_supenh/")

### reading in FC data

data <- read.table("/Users/sgrosche/Development/191127-BAF-timecourse-batch3/results/differential_analysis/200302-supenhancer-diff-any-condition-merged-deseq2-output.txt",header = T)
...
ggsave(paste("200302-boxplot-accessibility-log2FC-SMARCA4-timecourse-KO-diff-supenh-wolegend.pdf",sep = ""), plot = p, device = "pdf", path = NULL,
...
ggsave(paste("200302-boxplot-accessibility-log2FC-SMARCA4-timecourse-KO-diff-supenh-withlegend.pdf",sep = ""), plot = q, device = "pdf", path = NULL,
       scale = 1, height= 6, width = 8, dpi = 300, limitsize = TRUE)
...
ggsave(paste("200302-boxplot-accessibility-log2FC-ARID2KO-SMARCA4dtag-timecourse-KO-diff-supenh-wolegend.pdf",sep = ""), plot = p, device = "pdf", path = NULL,
       scale = 1, height= 6, width = 8, dpi = 300, limitsize = TRUE)
...
ggsave(paste("200302-boxplot-accessibility-log2FC-ARID2KO-SMARCA4dtag-timecourse-KO-diff-supenh-withlegend.pdf",sep = ""), plot = q, device = "pdf", path = NULL,
       scale = 1, height= 6, width = 8, dpi = 300, limitsize = TRUE)
...
ggsave(paste("200302-boxplot-accessibility-log2FC-CC1KO-CC2-timecourse-KO-diff-supenh-wolegend.pdf",sep = ""), plot = p, device = "pdf", path = NULL,
       scale = 1, height= 6, width = 8, dpi = 300, limitsize = TRUE)

q <- ggplot(data_filtered, aes(x=factor(comparison_name,level_vector), y=log2FoldChange, color = comparison_name)) + 
  geom_boxplot() + ylim(-10,5) + theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + scale_colour_npg() + geom_hline(yintercept=0, linetype="dashed", color = "black", size=0.5)

ggsave(paste("200302-boxplot-accessibility-log2FC-CC1KO-CC2-timecourse-KO-diff-supenh-withlegend.pdf",sep = ""), plot = q, device = "pdf", path = NULL,
       scale = 1, height= 6, width = 8, dpi = 300, limitsize = TRUE)
...
ggsave(paste("200302-boxplot-accessibility-log2FC-BRGKO-BRM-timecourse-KO-diff-supenh-wolegend.pdf",sep = ""), plot = p, device = "pdf", path = NULL,
       scale = 1, height= 6, width = 8, dpi = 300, limitsize = TRUE)

q <- ggplot(data_filtered, aes(x=factor(comparison_name,level_vector), y=log2FoldChange, color = comparison_name)) + 
  geom_boxplot() + ylim(-10,5) + theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + scale_colour_npg() + geom_hline(yintercept=0, linetype="dashed", color = "black", size=0.5)

ggsave(paste("200302-boxplot-accessibility-log2FC-BRGKO-BRM-timecourse-KO-diff-supenh-withlegend.pdf",sep = ""), plot = q, device = "pdf", path = NULL,
       scale = 1, height= 6, width = 8, dpi = 300, limitsize = TRUE)

...
data_sup_enh <- fread("BAF_Timecourse_Set3.chrom_state_annotation_HAP1_specific_singleline_active_enhancers.csv",data.table = F)

colnames(data_sup_enh) <- c("index","chr","pos1","pos2","annotation")
...
data_plot$time_point_rna_seq[1:1584] <- "2h"

data_plot$time_point_rna_seq[1585:3168] <- "3h"

data_plot$time_point_rna_seq[3169:4752] <- "6h"

data_plot$time_point_rna_seq[4753:6336] <- "24h"

data_plot$time_point_rna_seq[6337:7920] <- "72h"
...
ggsave("violin-WT-SMARCA4dtag-neg-log2FC1-atac-chip-all-rna-seq-active-enhancer-late-tp.pdf",height = 4, width = 5, dpi=300)
print(e)
dev.off()
...
data_plot$time_point_rna_seq[1:864] <- "2h"

data_plot$time_point_rna_seq[865:1728] <- "3h"

data_plot$time_point_rna_seq[1729:2592] <- "6h"

data_plot$time_point_rna_seq[2593:3456] <- "24h"

data_plot$time_point_rna_seq[3457:4320] <- "72h"
...
ggsave("violin-BRG-BRMdtag-neg-log2FC1-atac-chip-all-rna-seq-active-enhancer-late-tp.pdf",height = 4, width = 5, dpi=300)
print(e)
dev.off()
...
data_plot$time_point_rna_seq[1:2677] <- "2h"

data_plot$time_point_rna_seq[2678:5354] <- "3h"

data_plot$time_point_rna_seq[5355:8031] <- "6h"

data_plot$time_point_rna_seq[8032:10708] <- "24h"

data_plot$time_point_rna_seq[10709:13385] <- "72h"
...
ggsave("violin-CC1-CC2dtag-neg-log2FC1-atac-chip-all-rna-seq-active-enhancer-late-tp.pdf",height = 4, width = 5, dpi=300)
print(e)
dev.off()

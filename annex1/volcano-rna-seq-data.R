...
for (element in sample_vector){
  ...
  pdf(paste("volcano-plot-",element,"-deseq2-results-same-axes-wo-names.pdf",sep=""))
  print(volcano_plot)  
  dev.off()
...
pdf(paste("volcano-plot-",element,"-deseq2-results-independent-axis-wo-names.pdf",sep=""))
print(volcano_plot)  
dev.off()

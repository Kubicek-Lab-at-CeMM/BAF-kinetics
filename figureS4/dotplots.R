...
clustervector <- c("cluster6","cluster7","cluster8","cluster9","cluster10")
...
pdf("dotplot-HAP1-enrichment-timecourse-clusters-against-all-consensus-SL-clusters.pdf",useDingbats = F) 
print(dotplot)
dev.off()



### enrichment enhancer stratified all clusters BAF bound
...
dataframe_p_woBAF <- dataframe_p[c("BAF_bound_Enh","BAF_bound_EnhAct","BAF_bound_EnhBiv","BAF_bound_EnhGen","BAF_bound_EnhSup","BAF_bound_EnhWeak"),]
...
dataframe_or_woBAF <- dataframe_or[c("BAF_bound_Enh","BAF_bound_EnhAct","BAF_bound_EnhBiv","BAF_bound_EnhGen","BAF_bound_EnhSup","BAF_bound_EnhWeak"),]
...
dataframe_p_or_reshaped_merge$feature_p <- factor(dataframe_p_or_reshaped_merge$feature_p, levels = c("BAF_bound_Enh","BAF_bound_EnhAct","BAF_bound_EnhBiv","BAF_bound_EnhGen","BAF_bound_EnhSup","BAF_bound_EnhWeak"))
...
dotplot = ggplot(dataframe_p_or_reshaped_merge) +
  geom_point(mapping = aes(x= cluster_p, y=feature_p, size=or, colour = neg_log10_p_value_new)) +
  scale_colour_gradientn(colours = cols, breaks=c(1.3,10,20), limits = c(1.3,20),oob=squish,na.value="black") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 90))

pdf("dotplot-HAP1-enrichment-enhancers-BAF-stratified-all-clusters-against-all-consensus.pdf",useDingbats = F) 
print(dotplot)
dev.off()

...
dataframe_p_wBAF <- dataframe_p[c("BAF_bound_Enh_minus_EnhSup","BAF_bound_EnhAct_minus_EnhSup","BAF_bound_EnhBiv_minus_EnhSup","BAF_bound_EnhGen_minus_EnhSup","BAF_bound_EnhSup","BAF_bound_EnhWeak_minus_EnhSup","BRD4_BAF_bound","FlankTSS_BAF_bound","H3K27ac_BAF_bound","Heter_BAF_bound","PCRepr_BAF_bound","Pol2_BAF_bound","Quiesc_BAF_bound","TES_BAF_bound","Transc_BAF_bound","TSS_BAF_bound"),]
...
dataframe_or_wBAF <- dataframe_or[c("BAF_bound_Enh_minus_EnhSup","BAF_bound_EnhAct_minus_EnhSup","BAF_bound_EnhBiv_minus_EnhSup","BAF_bound_EnhGen_minus_EnhSup","BAF_bound_EnhSup","BAF_bound_EnhWeak_minus_EnhSup","BRD4_BAF_bound","FlankTSS_BAF_bound","H3K27ac_BAF_bound","Heter_BAF_bound","PCRepr_BAF_bound","Pol2_BAF_bound","Quiesc_BAF_bound","TES_BAF_bound","Transc_BAF_bound","TSS_BAF_bound"),]

dataframe_p_reshaped <- melt(dataframe_p_wBAF, id="feature")

dataframe_p_reshaped$value <- as.numeric(gsub(Inf,1000,dataframe_p_reshaped$value))

dataframe_or_reshaped <- melt(dataframe_or_wBAF, id="feature")
...
pdf("dotplot-HAP1-enrichment-all-clusters-against-all-consensus-BAF-stratification.pdf",useDingbats = F) 
print(dotplot)
dev.off()

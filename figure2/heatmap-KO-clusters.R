...
data_macs2_rpm <- read.csv("Chip.matrix_rpm.norm.for.atac.consensus.batch3.regions.csv")

colnames(data_macs2_rpm)[1] <- "index"

### calculating FC macs2 rpm data

data_macs2_rpm$FC_WT_SMARCA4dTAG_DMSO_24h_ARID1A <- log2((exp(data_macs2_rpm$WT_SMARCA4dTAG_dTAG47_24h_ARID1A) - 1) / (exp(data_macs2_rpm$WT_SMARCA4dTAG_DMSO_ARID1A)-1))

data_macs2_rpm$FC_WT_SMARCA4dTAG_DMSO_24h_BRD4 <- log2((exp(data_macs2_rpm$WT_SMARCA4dTAG_dTAG47_24h_BRD4) - 1) / (exp(data_macs2_rpm$WT_SMARCA4dTAG_DMSO_BRD4)-1))

data_macs2_rpm$FC_WT_SMARCA4dTAG_DMSO_24h_H3K27ac <- log2((exp(data_macs2_rpm$WT_SMARCA4dTAG_dTAG47_24h_H3K27ac) -1) / (exp(data_macs2_rpm$WT_SMARCA4dTAG_DMSO_H3K27ac)-1))

data_macs2_rpm$FC_SMARCA4KO_SMARCA2dTAG_DMSO_24h_ARID1A <- log2((exp(data_macs2_rpm$SMARCA4KO_SMARCA2dTAG_dTAG47_24h_ARID1A) -1) / (exp(data_macs2_rpm$SMARCA4KO_SMARCA2dTAG_DMSO_ARID1A)-1))

data_macs2_rpm$FC_SMARCA4KO_SMARCA2dTAG_DMSO_24h_BRD4 <- log2((exp(data_macs2_rpm$SMARCA4KO_SMARCA2dTAG_dTAG47_24h_BRD4) -1 ) / (exp(data_macs2_rpm$SMARCA4KO_SMARCA2dTAG_DMSO_BRD4)-1))

data_macs2_rpm$FC_SMARCA4KO_SMARCA2dTAG_DMSO_24h_H3K27ac <- log2((exp(data_macs2_rpm$SMARCA4KO_SMARCA2dTAG_dTAG47_24h_H3K27ac) -1 ) / (exp(data_macs2_rpm$SMARCA4KO_SMARCA2dTAG_DMSO_H3K27ac)-1))

data_macs2_rpm$FC_SMARCC1KO_SMARCC2dTAG_DMSO_24h_ARID1A <- log2((exp(data_macs2_rpm$SMARCC1KO_SMARCC2dTAG_dTAG47_24h_ARID1A) -1 ) / (exp(data_macs2_rpm$SMARCC1KO_SMARCC2dTAG_DMSO_ARID1A)-1))

data_macs2_rpm$FC_SMARCC1KO_SMARCC2dTAG_DMSO_24h_BRD4 <- log2((exp(data_macs2_rpm$SMARCC1KO_SMARCC2dTAG_dTAG47_24h_BRD4) -1 ) / (exp(data_macs2_rpm$SMARCC1KO_SMARCC2dTAG_DMSO_BRD4)-1))

data_macs2_rpm$FC_SMARCC1KO_SMARCC2dTAG_DMSO_24h_H3K27ac <- log2((exp(data_macs2_rpm$SMARCC1KO_SMARCC2dTAG_dTAG47_24h_H3K27ac) -1) / (exp(data_macs2_rpm$SMARCC1KO_SMARCC2dTAG_DMSO_H3K27ac)-1))
...
write.table(data_macs2_complete,"macs2-log2-FC-rpm-based.txt",quote = F,sep = "\t",row.names = F)
...
d <- dist(merge_all_chip_2[,-c(1,8:24)], method = "canberra") # distance matrix
...
pdf("Heatmap-FC-clustered-canberra-ward-rows-SMARCA4-KO.pdf")
